    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                    <div class="card-body">
                    <h1 class="card-title">{{ $Seafood->Name }}</h1>
                    <h3 class="card-subtitle mb-2 text-muted">${{ $Seafood->Price }}</h3>
                </div>
            ...
            <div class="col-md-12">
                ...
                <form action="/Seafood/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($Seafood->Comments) == 0 || $Seafood->Comments == null || empty($Seafood->Comments))
                    <h5 class="text-muted">No comments yet.</h5>
                @else
                    @foreach ($Seafood->Comments as $comment)
                    <div class="card col-md-12">
                        <div class="card-body">
            ...
            <a href="/Seafood/" class="card-link"> <br>&nbsp&nbsp&nbsp&nbsp&nbspGo back </br> </a>

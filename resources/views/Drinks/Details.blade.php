    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                    <div class="card-body">
                    <h1 class="card-title">{{ $drink->Beverage }}</h1>
                    <h3 class="card-subtitle mb-2 text-muted">{{ $drink->Price }}</h3>
                </div>
            ...
            <div class="col-md-12">
                ...
                <form action="/Drinks/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($drink->Comments) == 0 || $drink->Comments == null || empty($drink->Comments))
            ...
            <a href="/Drinks/" class="card-link"> <br>&nbsp&nbsp&nbsp&nbsp&nbspGo back </br> </a>
